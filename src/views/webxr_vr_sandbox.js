...
export default function init() {
  ...
  new RGBELoader()
    .load("public/textures/equirectangular/moonless_golf_1k.hdr", function (texture) {
  ...
  const texture0 = loader.load("public/textures/lensflare/lensflare0.png");
  const texture3 = loader.load("public/textures/lensflare/lensflare3.png");
